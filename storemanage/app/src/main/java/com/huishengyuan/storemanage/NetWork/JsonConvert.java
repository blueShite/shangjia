...
public class JsonConvert<T> implements Converter<T> {
    ...
    private T parseParameterizedType(Response response, ParameterizedType type) throws Exception {
        ...
        if (rawType != RequestBean.class) {
            ...
            RequestBean lzyResponse = Convert.fromJson(jsonReader, type);
            response.close();
            boolean code = lzyResponse.isRes();
                //这里的0是以下意思
            ...
            if (code) {
                ...
                throw new IllegalStateException("错误代码：" + code + "，错误信息：" + lzyResponse.getMes());
            }
        }
    }
}
